...
$rows = $pdo->query('SELECT id, name, header_html, footer_html, footer_bg_color, block_text_color, header_logo_url, header_mode, footer_logo_url, footer_mode, body_outline_color FROM email_design_templates ORDER BY name')->fetchAll(PDO::FETCH_ASSOC);
$templates = [];
foreach ($rows as $r) {
