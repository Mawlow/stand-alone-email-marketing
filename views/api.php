...
<!-- Banner (The "Identity") -->
<div class="api-banner bg-[#141d2e] text-white shadow-lg relative overflow-hidden hidden lg:block min-h-[97px] box-border border-b border-slate-700/50 flex items-center">
    <div class="max-w-6xl mx-auto w-full px-3 sm:px-4 md:px-6 lg:px-8 flex flex-row flex-wrap items-center justify-between gap-4 py-3">
        <div class="relative z-10 min-w-0 pt-2 md:pt-3">
            <h1 class="text-xl font-bold leading-tight md:text-2xl">API</h1>
            <p class="text-blue-100/80 mt-0.5 text-xs font-medium md:text-sm leading-snug">Integrate with external systems</p>
        </div>
    </div>
...
<div class="lg:hidden bg-[#141d2e] px-6 py-6 text-white mb-2 border-b border-slate-700/50 flex flex-col justify-center min-h-[97px] box-border">
    <h1 class="text-xl font-bold leading-tight pt-2 md:pt-3">API</h1>
    <p class="text-blue-100/80 text-xs mt-1 leading-snug">Integrate systems</p>
</div>
