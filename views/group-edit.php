...
<!-- Group Edit Banner -->
<div class="group-edit-banner bg-[#02396E] py-6 md:py-8 text-white shadow-lg relative overflow-hidden">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="mb-4">
            <a href="<?= url('groups') ?>" class="inline-flex items-center gap-2 text-blue-100/60 hover:text-[#ff8904] font-bold text-sm transition-colors group">
                <span class="p-1 rounded-lg border border-white/20 group-hover:border-[#ff8904] transition-colors">
        ...
        <div>
            <h1 class="text-[2rem] font-bold leading-tight"><?= $group ? 'Edit Group' : 'Add New Group' ?></h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-slate-100 bg-slate-50 border-b border-slate-100">
            ...
            <div class="p-6">
                ...
                <form id="quickCreateForm" method="post" action="<?= url('group-edit', ['id' => $groupId]) ?>" class="flex flex-col sm:flex-row gap-2">
                    ...
                    <button type="submit" class="px-4 py-[5px] bg-[#ff8904] text-white font-bold rounded-xl hover:bg-[#f54a00] transition-all text-sm">Create & Add</button>
                </form>
            </div>
        </div>
