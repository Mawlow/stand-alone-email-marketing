                    ...
                    <tr>
                        <td colspan="3" class="px-4 md:px-8 pt-8 pb-20 text-center">
                            <div class="flex flex-col items-center justify-center space-y-4">
                                ...
                                <div>
                                    <p class="text-xl md:text-2xl font-bold text-slate-400 uppercase tracking-wider">No Email Groups Found</p>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-t border-slate-100 hover:bg-slate-50">
                        <td class="px-4 md:px-8 py-4 font-semibold text-slate-900"><?= h($sg['name']) ?></td>
                        <td class="px-4 md:px-8 py-4 text-center text-slate-600 font-medium"><?= (int)($sg['recipient_count'] ?? 0) ?></td>
                        <td class="px-4 md:px-8 py-4 text-right">
                            <div class="flex justify-end gap-2">
                                <a href="<?= url('sms') ?>" class="p-2 text-[#02396E] hover:bg-blue-50 rounded-lg transition-colors" title="Manage in SMS">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-4l-4 4v-4z"></path></svg>
                                </a>
                                <form method="post" action="<?= url('groups') ?>" class="inline">
                                    ...
                                    <button type="submit" class="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors" onclick="return confirm('Delete SMS group <?= h($sg['name']) ?>?');" title="Delete">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                    </button>
                                </form>
                            </div>
                    ...
                    <tr>
                        <td colspan="3" class="px-4 md:px-8 pt-8 pb-12 text-center">
                            <p class="text-lg font-bold text-slate-400 uppercase tracking-wider">No SMS Groups Found</p>
